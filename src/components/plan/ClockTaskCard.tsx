...
import { Clock, Users, Tag, Package } from 'lucide-react';
import { Task } from '../views/CreatePlanView';

interface ClockTaskCardProps {
  task: Task;
...
export function ClockTaskCard({ task, position }: ClockTaskCardProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed z-50 bg-white rounded-xl shadow-2xl w-72 border border-gray-200"
      style={{
        left: `${position.x}px`,
        top: `${position.y}px`,
