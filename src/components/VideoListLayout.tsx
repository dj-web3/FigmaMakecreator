      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="h-14 border-b border-gray-200 flex items-center justify-between px-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base font-medium">Chicken Biryani - A step-by-step guide to the best rice dish ever</h1>
          </div>
          <div className="flex items-center gap-2">
            <button 
              onClick={() => setShowAIDrawer(true)}
              className="bg-[#FE5D4D] hover:bg-[#e54d3d] text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium transition-colors"
            >
        ...
        {/* Filter Bar */}
        <div className="h-12 border-b border-gray-200 flex items-center justify-end px-6">
